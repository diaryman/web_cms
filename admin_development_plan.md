...
- [ ] ปรับปรุง Admin Layout ให้เป็นภาษาไทยทั้งหมด
- [ ] เพิ่ม Context เพื่อแยกการทำงานระหว่าง DataGOV และ PDPA
- [ ] สร้าง Sidebar Menu ที่เปลี่ยนตามบริบทของไซต์ที่เลือก
...
- [ ] **จัดการจุดเด่น/หลักการ (Features Management)** *New*
...
---
**สถานะปัจจุบัน**: เริ่มดำเนินการ Phase 1 และ 2
