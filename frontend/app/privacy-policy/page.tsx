...
export async function generateMetadata(): Promise<Metadata> {
    ...
    try {
        ...
        const title = res.data?.[0]?.legalPages?.privacyPolicy?.title || "นโยบายความเป็นส่วนตัว";
        return { title, description: "นโยบายความเป็นส่วนตัวของเว็บไซต์" };
    } catch { return { title: "นโยบายความเป็นส่วนตัว" }; }
}
...
export default async function PrivacyPolicyPage() {
    ...
    let page = { title: "นโยบายความเป็นส่วนตัว", content: "" };
