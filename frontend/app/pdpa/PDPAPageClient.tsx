...
export default function PDPAPageClient({ navbar, footer, siteConfig, features = [] }: PDPAPageClientProps) {
    ...
    return (
        <main className="min-h-screen bg-[#f8fafc]" style={{ "--selection-bg": "var(--accent-subtle)" } as React.CSSProperties}>
            ...
            {/* Divider wave */}
            <div style={{ background: "#f8fafc", lineHeight: 0, overflow: "hidden" }}>
            ...
            <div style={{ background: "#f8fafc", lineHeight: 0, overflow: "hidden" }}>
                <svg viewBox="0 0 1440 80" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none" style={{ display: "block", width: "100%", height: 80 }}>
                    <path d="M0,80 C480,0 960,0 1440,80 L1440,80 L0,80 Z" fill="#ffffff" />
                </svg>
            </div>
            ...
            <div style={{ background: "#ffffff", lineHeight: 0, overflow: "hidden" }}>
                <svg viewBox="0 0 1440 70" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none" style={{ display: "block", width: "100%", height: 70 }}>
                    <path d="M0,0 L0,70 L1440,70 L1440,0 C1200,40 960,0 720,30 C480,60 240,20 0,0 Z" fill="#f8fafc" />
                </svg>
            </div>
