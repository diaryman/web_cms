...
export default function ContactPageClient({ navbar, footer, contactForm, siteConfig, domain }: ContactPageClientProps) {
        ...
        <main className="min-h-screen bg-[#f8fafc] selection:bg-blue-100">
            ...
            <div className="pt-[calc(6rem+44px)] pb-20 relative overflow-hidden text-center bg-white border-b border-gray-100">
                ...
                <div className="max-w-4xl mx-auto px-4 relative z-10">
                    ...
                    <h1 className="text-4xl md:text-6xl font-black font-heading text-slate-900 mb-6 tracking-tight leading-tight">
                        ติดต่อสอบถาม <br />
                        <span className={accentColor}>{isPDPA ? "ศูนย์ PDPA" : "งานธรรมาภิบาลข้อมูล"}</span>
                    </h1>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 -mt-10 relative z-10">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                    ...
                    <div className="space-y-8 order-2 lg:order-1">
                        <div className="bg-white p-8 rounded-[2.5rem] shadow-premium border border-gray-100">
                            ...
                            <ul className="space-y-6">
                                <li className="flex gap-4 items-start">
                                    <div className={`w-12 h-12 ${bgAccent} rounded-2xl flex items-center justify-center flex-shrink-0 text-primary`}>
                        ...
                        <div className="bg-slate-900 p-8 rounded-[2.5rem] shadow-xl text-white relative overflow-hidden">
                            <div className="relative z-10">
                                <h3 className="text-2xl font-black font-heading mb-4">เวลาทำการ</h3>
                                <p className="opacity-80 leading-relaxed mb-6 whitespace-pre-line">
                    ...
                    {/* Contact Form Side */}
                    <div className="bg-white p-8 md:p-12 rounded-[3rem] shadow-2xl shadow-blue-900/10 border border-gray-100 order-1 lg:order-2">
