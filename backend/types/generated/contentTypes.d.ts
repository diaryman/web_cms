...
export interface ApiGalleryGallery extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Store image albums for both sites';
    displayName: 'Gallery';
...
export interface ApiNewsletterSubscriberNewsletterSubscriber
  ...
  info: {
    description: '\u0E1C\u0E39\u0E49\u0E2A\u0E21\u0E31\u0E04\u0E23\u0E23\u0E31\u0E1A\u0E02\u0E48\u0E32\u0E27\u0E2A\u0E32\u0E23 (Newsletter)';
  ...
  attributes: {
    ...
    name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    source: Schema.Attribute.Enumeration<['website', 'admin', 'import']> &
...
export interface ApiPagePage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    sections: Schema.Attribute.DynamicZone<
      ['shared.hero', 'shared.rich-text', 'shared.news-grid']
    >;
    slug: Schema.Attribute.UID<'title'> & Schema.Attribute.Required;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiSiteConfigSiteConfig extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Configuration for multiple sites';
